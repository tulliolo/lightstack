...
if [[ -f default.conf ]]; then
    ...
    echo ">>>A previous installation of this stack was detected<<<"
    echo "In order to use multistack, you need to migrate your current configuration. All data will be preserved."
    read -p "Would you like to continue (y/N)?: " migrateyesno
    echo
    ...
    mkdir -p .migration
    mv -t .migration default.conf docker-compose.yml .env data letsencrypt lnbitsdata pgdata pgtmp
    echo "All data has been backed up"
fi
